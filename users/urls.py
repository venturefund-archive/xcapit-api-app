...
from .views import RegistrationAPIView, EmailValidationTokenAPIView, \
    ...
    ChangePasswordAPIView, IsSuperUserAPIView, GetUserAPIView, ByEmailAPIView, SendEmailValidationByEmailView
...
urlpatterns = [
    ...
    path('send_email_validation_by_email', SendEmailValidationByEmailView.as_view(),
         name='send-email-validation_by_email'),
